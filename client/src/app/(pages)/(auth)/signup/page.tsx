...
export default function JoySignInSideTemplate() {
  ...
  async function onSubmitSignup(data: z.infer<typeof FormSchema>) {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_URL}/main_server/api/user/signup`, {
        method: "POST",
        headers: {
            ...
            <div className="relative z-10 h-full flex flex-col p-12 text-white">
              ...
              <div className="mt-auto space-y-6">
                ...
                <p className="text-white/80 max-w-md">
                  Become part of our growing ecosystem of users enjoying premium features.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="rounded-xl bg-background/50 p-8 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] backdrop-blur-sm border border-white/10">
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-6">
                    <Button
                      variant="outline"
                      className="w-full h-12 rounded-lg border-border/50 hover:bg-background/80"
                      asChild
                    >
                      <Link href="/login">
                        Sign in instead
