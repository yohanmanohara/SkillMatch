        ...
        <CardHeader className="flex-row items-start space-y-0 pb-0">
          ...
          <Select value={String(activeLabel)} onValueChange={setActiveLabel}>
            ...
            <SelectContent align="end" className="rounded-xl">
              {data.map((item) => (
                <SelectItem key={String(item[labelKey as keyof DataItem])} value={String(item[labelKey as keyof DataItem])}>
          ...
          >
            <PieChart>
              ...
              <Pie
                ...
                dataKey={valueKey}
                nameKey={labelKey}
                innerRadius={80} // Increased from 100 to 80 (smaller hole)
                outerRadius={120} // Increased from default to 140 (larger outer boundary)
                strokeWidth={2} // Increased stroke width for thicker borders
