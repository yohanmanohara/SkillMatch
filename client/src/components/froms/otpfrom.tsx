...
import Otpfrom from '@/components/froms/otpfrom';
...
const OtpForm: React.FC<OtpFormProps> = ({ setIsSentOtp }) => {
            ...
            <Typography level="body-md" textAlign="center">
             Plz check your email for OTP
              ...
              <Stack gap={4} direction="row">
                        ...
                        <Button 
                          type="button" 
                          onClick={() => setIsSentOtp(false)} // Setting false to cancel OTP state
                          fullWidth
                          sx={{
                            backgroundColor: 'red', 
                            '&:hover': {
