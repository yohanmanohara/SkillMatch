      ...
      <div className='flex flex-row bg-green-200 rounded-md w-auto h-96 p-24 m-10 gap-48 items-center justify-between' id='contact'>
        ...
        <div className='flex flex-col gap-4'>
          <div className='flex flex-row gap-8'>
            <Input type="text" placeholder="Name" className='text-black placeholder-gray-400 focus:bg-gray-700' />
            <Input type="email" placeholder="Email" className='text-black placeholder-gray-400 focus:bg-gray-700' />
          </div>
          <Input type="text" placeholder="Subject" className='text-black placeholder-gray-400 focus:bg-gray-700' />
          <Textarea placeholder="Message" className="resize-none text-black placeholder-gray-400 focus:bg-gray-700" />
